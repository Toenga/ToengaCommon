...
import fr.toenga.common.utils.permissions.Permission;
import fr.toenga.common.utils.permissions.PermissionSet;
...
public class PermissibleExample
{
	...
	public static void main(String[] args)
	{
		...
		Permissible permissible = new Permissible(inheritances, permissionSet);
